...
```{r}
# need help on what code to use to clean the data because of the strange format and multiple files

#path:  https://github.com/amp5/QMSS_G5069_Applied_D_S/tree/master/Data:Code%20Book/Raw:Outdated/historical_citywide_crime_complaint_data_by_precinct_2000_2015
```
