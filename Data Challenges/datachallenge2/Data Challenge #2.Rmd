...
###suggest this question is worth pursuing further? why or why not?
    * It is interesting that the cubic model predicts the best out of all the models
    ...
    above related to the viilations of regression assumptions, especially that the 
    data are notmally distributed. Predicting whether or not people will be detained 
    using all weapons seized and wounded organized crime members as predictors
    ...
    detain more people. not worth pursuing bc of the limtiations discovered in #1c
