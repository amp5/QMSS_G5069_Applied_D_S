...
linear <- lm(detained ~ weapons_seized + organized.crime.wounded, 
             data = AllData, 
             subset = training)

quadratic <- lm(detained ~ poly(weapons_seized + organized.crime.wounded, degree = 2),
                data = AllData,
                subset = training)
 
cubic <- lm(detained ~ poly(weapons_seized + organized.crime.wounded, degree = 3),
            data = AllData,
            subset = training)

quartic <- lm(detained ~ poly(weapons_seized + organized.crime.wounded, degree = 3),
              data = AllData,
              subset = training)

p_linear <- predict(linear, newdata = testing)
