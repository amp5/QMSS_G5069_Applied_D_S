...
total_figures_new <- as.data.frame(total_figures_new)

ggplot(data = total_figures_new, aes(x = V1)) +
  geom_bar(stat = "identity")

ggplot(data = total_figures, 
       aes(`Weapons Seized (People Detained)`,
           `Weapons Seized (No One Detained)`,
           `Organized Crime Members Wounded (People Detained)`,
           `Organized Crime Members Wounded (No One Detained)`)
       ) +
  geom_bar(stat = "identity") +
