...
```
  * Analysis of the output:  the cubic regression model had the highest 
...
###or to the data itself
  * The limitations of the cubic regression model is shown through various diagnostic 
  plots using the entire dataset:
...
```  
  ...
  1.) __Residuals vs Fitted plot:__ 
  
  2.) __Normal Q-Q plot:__
  
  3.) __Scale-Location plot:__ 
  
  4.) __Residuals vs Leverage plot:__
...
###suggest this question is worth pursuing further? why or why not?
    *  predicting not detained is much better than predicting detained. might not be worth
    persuing my question bc these models would help the Mexican authorities 
    detain more people.
