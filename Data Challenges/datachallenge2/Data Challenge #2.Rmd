...
#:::::::::::::::OLS - doesn't work = DELETE:
lm1_ols <- lm(military ~ clips.seized + cartridge.sezied + small.arms.seized + long.guns.seized, 
          data = AllData_excluded)

summary(lm1_ols)

plot(lm1_ols) # non-liner - can't use it

lm2_ols <- lm(all_others ~ clips.seized + cartridge.sezied + small.arms.seized + long.guns.seized, 
          data = AllData_excluded)

summary(lm2_ols)

plot(lm2_ols) # non-liner - can't use it

#::::::::::::::: Random Forest:
#fits model on training set
RandomForestFit_1 <- train(military ~ 
                             clips.seized + 
                             cartridge.sezied + 
                             small.arms.seized + 
                             long.guns.seized, 
