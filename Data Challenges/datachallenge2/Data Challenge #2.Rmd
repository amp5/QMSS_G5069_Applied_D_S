...
```  
  ...
  1.) __Residuals vs Fitted plot:__ This plot shows if residuals have non-linear 
  ...
  2.) __Normal Q-Q plot:__ This plot shows if residuals are normally distributed.  Since
  the points on the graph are not 
