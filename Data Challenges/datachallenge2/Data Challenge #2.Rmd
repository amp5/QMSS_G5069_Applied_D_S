...
```  
  ...
  be influential to regresson results.  The extreme outliers that may be heavily
  influential to the regression results are outliers # 135 and 1429.  These outliers
  deviate the most from the 
