...
lm_new_quadratic <- lm(detained ~ poly(weapons_seized + organized.crime.wounded, degree = 2),
                 data = AllData)

summary(lm_new_quadratic)

plot(lm_new_quadratic) 


lm_new_cubic <- lm(detained ~ poly(weapons_seized + organized.crime.wounded, degree = 3),
                 data = AllData)

summary(lm_new_cubic)

plot(lm_new_cubic) 


lm_new_quartic <- lm(detained ~ poly(weapons_seized + organized.crime.wounded, degree = 3),
                 data = AllData)

summary(lm_new_quartic)
...
train <- sample(nrow(AllData), 2698) ## split in half
training <- AllData[train, ] 
testing <- AllData[-train, ]

#Random Forest:
#bagged <- randomForest(detained ~ 
#                             weapons_seized +
...
RandomForestFit_1 <- train(detained ~ 
                             weapons_seized +
                             organized.crime.wounded,
                           data = training,
