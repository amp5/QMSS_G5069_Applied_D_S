...
#subset - only showinteractions with federal forces so exclude all other forces:
attempt5 <- subset(fullData, 
                   total.people.wounded == 0 & 
                   state.police.dead == 0 &
                   ministerial.police.dead == 0 &
                   municipal.police.dead == 0 &
                   public.prosecutor.dead == 0)

fig1 <- (sum(attempt5$civilian.dead) / sum(attempt5$total.people.dead)) * 100
