...
#with federal armed forces (army and navy) were killed in events of "perfect lethality" where 
#there were only dead and no wounded:

#of all civilian deaths, how many deaths were at the hands of th army and navy with zero people wounded?

sum(fullData$civilian.dead)
attempt17 <- subset(fullData, 
                   total.people.wounded == 0 &
                   military.dead > 0 &
                     navy.dead > 0 )
sum(attempt17$civilian.dead)

#Overall lethality ratio:
OLR <- 

#Federal Police:
FP <- (sum(fullData$federal.police.dead) / sum(fullData$federal.police.wounded))
